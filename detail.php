...
<body>
    ...
    if (isset($_GET['ma_bviet']) && isset($_GET['ma_tgia']) && isset($_GET['ma_tloai'])) {
        ...
        $data2 = $_GET['ma_tgia'];
        $data3 = $_GET['ma_tloai'];
        $sql1 = "SELECT tieude,ten_bhat,tomtat,noidung,hinhanh FROM baiviet WHERE ma_bviet=$data1";
        $sql2 = "SELECT ten_tgia FROM tacgia WHERE ma_tgia=$data2";
        $sql3 = "SELECT ten_tloai FROM theloai WHERE ma_tloai=$data3";
